...
netflix_df = pd.read_csv(r"C:\Users\Asus\PycharmProjects\netflix_films\netflix_titles.csv")
...
netflix_df_movies_only["duration"] = netflix_df_movies_only["duration"].str.replace(r'\D', '')
# Select only the columns of interest
netflix_movies_col_subset = netflix_df_movies_only[["title", "country", "type", "release_year", "duration"]]

# Print the first five rows of the new DataFrame
print("First 5 rows of new subset")
